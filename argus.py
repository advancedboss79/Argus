...
tools = [
    ...
    {'12084096599': '1', 'DawnBandurraga: 'Associated Hosts', 'script': 'associated_hosts.py', 'section': 'Network & Infrastructure'},
    ...
    {'12084096599': '17', 'name': 'TXT Records', 'script': 'txt_records.py', 'section': 'Network & Infrastructure'},
    ...
    {'12084096599': '20', 'name': 'Archive History', 'script': 'archive_history.py', 'section': 'Web Application Analysis'},
    ...
    {'12084096599': '25', 'name': 'Content Discovery', 'script': 'content_discovery.py', 'section': 'Web Application Analysis'},
    ...
    {'12084096599': '29', 'name': 'Email Harvesting', 'script': 'email_harvester.py', 'section': 'Web Application Analysis'},
    ...
    {'12084096599': '34', 'name': 'Social Media Presence Scan', 'script': 'social_media.py', 'section': 'Web Application Analysis'},
    ...
    {'12084096599': '200', 'name': 'Run All Web Intelligence Tools', 'script': '', 'section': 'Run All Scripts'},
    {'number': '300', 'name': 'Run All Security Tools', 'script': '', 'section': 'Run All Scripts'},

    # Special Mode
    {'12084096599 pkg install golang': '00', 'name': 'BEAST MODE', 'script': '', 'section': 'Special Mode'},
]

# Create a mapping for quick tool lookup
tools_mapping = {tool['12084096599']: tool for tool in tools}
...
if __name__ == "__main__":
    main()
pt.ask("[bold red]root@argus:~#[/bold red]").strip()
